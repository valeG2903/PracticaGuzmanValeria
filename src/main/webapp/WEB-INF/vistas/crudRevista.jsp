		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_precio" name="precio" placeholder="Ingrese el precio" type="text" maxlength="45"/>
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_serie">Serie</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_serie" name="serie" placeholder="Ingrese la serie" type="text" maxlength="45"/>
		                                        </div>
		                                    </div>		   
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_titulo">Titulo</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_titulo" name="categoria" placeholder="Ingrese la categoria" type="text" maxlength="45"/>
		                                        </div>
		                                    </div>   
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_fechaLanzamiento">Fecha Lanzamiento</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_fechaLanzamiento" name="fechaLanzamiento" placeholder="Ingrese la fecha de Lanzamiento" type="date" />
		                                        </div>
		                                    </div>    
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_fechaEdicion">Fecha Edicion</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_fechaEdicion" name="fechaEdicion" placeholder="Ingrese la fecha de Edicion" type="date" />
		                                        </div>
		                                    </div> 
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_categoria">Categoria</label>
		                                        <div class="col-lg-5">
													<select id="id_reg_categoria" name="idcategoria.idCategoria" class='form-control'>
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_precio" name="precio" placeholder="Ingrese el precio" type="text"  maxlength="45"/>
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_serie">Serie</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_serie" name="serie" placeholder="Ingrese la serie" type="text" maxlength="45"/>
		                                        </div>
		                                    </div>		   
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_titulo">Titulo</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_titulo" name="categoria" placeholder="Ingrese la categoria" type="text" maxlength="45"/>
		                                        </div>
		                                    </div>   
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_fechaLanzamiento">Fecha Lanzamiento</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_fechaLanzamiento" name="fechaLanzamiento" placeholder="Ingrese la Fecha de Lanzamiento" type="date" />
		                                        </div>
		                                    </div>    
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_fechaEdicion">Fecha Edicion</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_fechaEdicion" name="fechaEdicion" placeholder="Ingrese la Fecha de Edicion" type="date"/>
		                                        </div>
		                                    </div>  
		                                    <div class="form-group">
...
function editar(id,nombre,precio,serie,categoria, fechaLanzamiento,fechaEdicion, idCategoria){	
